...
void main() {
  ...
  void poser(List<Echeance> liste) =>
      harnais.poser(codec.encoder(codec.documentNeuf(versionCourante), liste));
  ...
  testWidgets(
    'La page de gestion sans aucune échéance affiche un état vide sobre',
    (tester) async {
  ...
  testWidgets('Ouvrir la gestion ne rend pas interactifs les modules grisés', (
    tester,
  ) async {
  ...
  testWidgets('Une échéance est créée avec une description et une date', (
    tester,
  ) async {
  ...
  testWidgets('Une création sans description est refusée', (tester) async {
    await ouvrirApplication(tester);
    await ouvrirGestion(tester);
    await ouvrirFormulaire(tester);
    await saisir(
  ...
  testWidgets('Une description composée uniquement de blancs est refusée', (
    tester,
  ) async {
    await ouvrirApplication(tester);
    await ouvrirGestion(tester);
  ...
  testWidgets('Une description trop longue est refusée', (tester) async {
    await ouvrirApplication(tester);
    await ouvrirGestion(tester);
    await ouvrirFormulaire(tester);
  ...
  testWidgets('Les espaces de début et de fin de la description sont retirés', (
    tester,
  ) async {
    await ouvrirApplication(tester);
    await ouvrirGestion(tester);
  ...
  testWidgets('Une création sans date est refusée', (tester) async {
    await ouvrirApplication(tester);
    await ouvrirGestion(tester);
    await ouvrirFormulaire(tester);
  ...
  testWidgets(
    'Une échéance du jour courant sans heure reste valide avant 23h59',
    (tester) async {
  ...
  testWidgets('Une échéance placée dans le passé est refusée', (tester) async {
    await ouvrirApplication(tester);
    await ouvrirGestion(tester);
    await ouvrirFormulaire(tester);
    await saisir(
  ...
  testWidgets('Une échéance dont le temps restant est nul est refusée', (
    tester,
  ) async {
  ...
  testWidgets("Une édition qui place l'échéance dans le passé est refusée", (
    tester,
  ) async {
  ...
  testWidgets('La neuvième échéance est créée normalement', (tester) async {
  ...
  testWidgets(
    'La dixième création est refusée avec un message nommant la limite',
    (tester) async {
      ...
      expect(
        ...
        findsWidgets,
        reason: 'le message NOMME la limite',
      );
      ...
      expect(
        persistees(),
        hasLength(9),
        reason: 'le stockage contient TOUJOURS 9',
      );
    },
  );

  testWidgets(
    'Une échéance échue présente sur la grille compte dans la limite de neuf',
    (tester) async {
      poser([
  ...
  testWidgets('Supprimer une échéance libère une place', (tester) async {
  ...
  testWidgets(
    'La modification de la description est reflétée sur la grille sans redémarrage',
    (tester) async {
  ...
  testWidgets(
    'La modification de la date recalcule le nombre affiché sur la tuile',
    (tester) async {
      ...
      await saisir(
        tester,
        date: jjmmaaaa(maintenant.add(const Duration(days: 5))),
      );
      await enregistrer(tester);
      await revenir(tester);
  ...
  testWidgets(
    "Une édition invalide est refusée et l'échéance conserve ses valeurs d'origine",
    (tester) async {
      poser([ech('a', const Duration(days: 10), 'Convention')]);
      await ouvrirApplication(tester);
      await ouvrirGestion(tester);
  ...
  testWidgets("L'édition d'une échéance échue est refusée", (tester) async {
  ...
  testWidgets("Annuler une édition laisse l'échéance inchangée", (
    tester,
  ) async {
    poser([ech('a', const Duration(days: 10), 'Convention')]);
    await ouvrirApplication(tester);
  ...
  testWidgets('La suppression demande une confirmation explicite', (
    tester,
  ) async {
    poser([ech('a', const Duration(days: 10), 'Convention')]);
    await ouvrirApplication(tester);
  ...
  testWidgets("Annuler la confirmation laisse l'échéance en place", (
    tester,
  ) async {
    poser([ech('a', const Duration(days: 10), 'Convention')]);
    await ouvrirApplication(tester);
  ...
  testWidgets('Une échéance supprimée ne réapparaît pas après réouverture', (
    tester,
  ) async {
    poser([ech('a', const Duration(days: 10), 'Convention')]);
    await ouvrirApplication(tester);
  ...
  testWidgets('Une échéance échue est supprimable définitivement', (
    tester,
  ) async {
  ...
  testWidgets(
    'La page de gestion liste les échéances actives et les échues dans deux groupes',
    (tester) async {
  ...
  testWidgets('Une échéance à description vide reste listée et manipulable', (
    tester,
  ) async {
  ...
  testWidgets('La page de gestion affiche le temps restant avec son unité', (
    tester,
  ) async {
    poser([ech('a', const Duration(days: 3), 'Visite')]);
    await ouvrirApplication(tester);
  ...
  testWidgets(
    "Les échéances et leur état sont restitués à l'identique après réouverture",
    (tester) async {
      poser([
  ...
  testWidgets(
    "Aucune donnée ne quitte l'appareil et aucun appel réseau n'est émis",
    (tester) async {
  ...
  testWidgets(
    "Un enregistrement local illisible est ignoré sans empêcher l'ouverture",
    (tester) async {
      harnais.poser(
  ...
  testWidgets(
    "Un stockage entièrement illisible conduit à l'état vide et jamais à une erreur technique",
    (tester) async {
      ...
      expect(
        ...
        startsWith('echeances.json.illisible-'),
      );
    },
  );

  testWidgets(
    "Les échéances d'une version antérieure du stockage restent intactes après migration",
    (tester) async {
      ...
      final relues = {
        for (final e in persistees()) e.description: e.dateEcheance,
      };
  ...
  testWidgets(
    'Une migration interrompue laisse les données dans leur état antérieur',
    (tester) async {
      const v1 =
          '{"schemaVersion":1,"echeances":['
          '{"id":"a1","description":"Convention","dateEcheance":"2027-03-15T22:59:00.000Z"},'
  ...
  testWidgets("Le retour arrière de migration restitue l'état antérieur sans perte", (
    tester,
  ) async {
    const v1 =
        '{"schemaVersion":1,"echeances":['
  ...
  testWidgets(
    "La grille affiche les échéances persistées et non plus les données d'exemple",
    (tester) async {
      poser([
  ...
  testWidgets("Sur une installation neuve la grille affiche l'état vide", (
    tester,
  ) async {
  ...
  testWidgets('Une échéance créée apparaît sur la grille sans redémarrage', (
    tester,
  ) async {
    poser([
  ...
  testWidgets(
    "Une échéance conserve la date et l'heure saisies après relecture",
    (tester) async {
      await ouvrirApplication(tester);
      await ouvrirGestion(tester);
  ...
  testWidgets('La date persistée ne porte ni fuseau ni décalage horaire', (
    tester,
  ) async {
    await ouvrirApplication(tester);
    await ouvrirGestion(tester);
    ...
    expect(
      valeur,
      isNot(contains('Z')),
      reason: 'aucune marque de temps universel',
    );
  ...
  testWidgets(
    "Les champs du formulaire portent un libellé annoncé par le lecteur d'écran",
    (tester) async {
      await ouvrirApplication(tester);
      await ouvrirGestion(tester);
      await ouvrirFormulaire(tester);
  ...
  testWidgets(
    'Un message de validation reste sobre et sans élément anxiogène',
    (tester) async {
      await ouvrirApplication(tester);
      await ouvrirGestion(tester);
      await ouvrirFormulaire(tester);
  ...
  testWidgets(
    "Une date qui n'existe pas au calendrier est refusée sans correction silencieuse",
    (tester) async {
      ...
      expect(
        harnais.octets(),
        isNull,
        reason: 'le stockage ne contient AUCUNE échéance',
      );
  ...
  testWidgets(
    "Une édition vers une date qui n'existe pas au calendrier est refusée",
    (tester) async {
      final anneeProchaine = maintenant.year + 1;
      poser([ech('a', const Duration(days: 10), 'Convention')]);
      await ouvrirApplication(tester);
  ...
  testWidgets("Un échec d'écriture est annoncé et rien n'est enregistré", (
    tester,
  ) async {
  ...
  testWidgets(
    "Après un échec d'écriture la saisie est conservée et la nouvelle tentative aboutit",
    (tester) async {
      harnais.bloquerEcriture();
      await ouvrirApplication(tester);
      await ouvrirGestion(tester);
  ...
  testWidgets(
    "Une suppression qui ne peut pas être écrite laisse l'échéance en place",
    (tester) async {
