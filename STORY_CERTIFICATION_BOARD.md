...
| US-00.1 | Secrets & scan de dépôt | parallel_audit | ✅ @PO | N/A | N/A | ✅ @Dev | ✅ 🔍 | ✅ 🛡️ | ⏳ | ⏳ | ⏳ |
...
- **Prochaine étape** : **QA** (exécution réelle des suites + non-régression) → transition phase `quality_assurance`.
